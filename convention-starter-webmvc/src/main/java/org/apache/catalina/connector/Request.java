...
/**
 * org.org.apache.tomcat.embed:tomcat-embed-core:9.0.43
 * org.org.apache.catalina.connector.Request.class
 */
...
public class Request implements HttpServletRequest {
    ...
    private static final Log log = LogFactory.getLog(org.apache.catalina.connector.Request.class);
    ...
    //////////////////////
    // 如果需求记录请求体, 那么就需求额外读取一次inputStream, 这个 body 就用来多次读取时使用
    //////////////////////
     ...
     */
    protected static final StringManager sm = StringManager.getManager(org.apache.catalina.connector.Request.class);
     ...
     * calls to {@link org.apache.catalina.connector.Request#getAttributeNames()}.
     */
     ...
     * have names starting with "org.org.apache.tomcat" and include:
     * <ul>
    ...
    public ServletInputStream getInputStream() throws IOException {
        ...
        if (WebMvcRequestUtils.canLogBodyByByte(this, body)) {
            if (body == null) {
                synchronized (this) {
                    if (body == null) {
                        // 使用原本 getReader()
                        body = gaarason.convention.common.util.StringUtils.readBytes(originallyGetReader(), characterEncoding);
                    }
                }
            }
    ...
    public Map<String, String[]> getParameterMap() {
        ...
        /////////////////////
        WebMvcRequestUtils.printHttpProviderReceivedRequestBodyLog(this, parameterMap);
    ...
    public BufferedReader getReader() throws IOException {
        ...
        if (WebMvcRequestUtils.canLogBodyByByte(this, body)) {
            ...
            // 原方法
            return originallyGetReader();
        }

    }

    public BufferedReader originallyGetReader() throws IOException {
    ...
    public void removeAttribute(String name) {
        ...
        if (name.startsWith("org.org.apache.tomcat.")) {
    ...
    private static interface SpecialAttributeAdapter {
        Object get(org.apache.catalina.connector.Request request, String name);

        void set(org.apache.catalina.connector.Request request, String name, Object value);
    ...
    static {
        specialAttributes.put(Globals.DISPATCHER_TYPE_ATTR,
                new SpecialAttributeAdapter() {
                    @Override
                    public Object get(org.apache.catalina.connector.Request request, String name) {
                        return (request.internalDispatcherType == null) ? DispatcherType.REQUEST
                                : request.internalDispatcherType;
                    }

                    @Override
                    public void set(org.apache.catalina.connector.Request request, String name, Object value) {
