...
public class StringUtils {
     ...
     */
    public static String mapToQuerySearch(@Nullable Map<String, Object> paramsMap) {
     ...
     * @throws BusinessException HTTP参数构造异常
     */
    public static String mapToQuerySearch(@Nullable Map<String, Object> paramsMap, boolean sort) {
     ...
     * @return 处理后的字符
     */
    public static String lineToHump(@Nullable String str, boolean... firstIsUpperCase) {
        if(ObjectUtils.isEmpty(str)){
            return FinalVariable.EMPTY_STRING;
        }
     ...
     * @return 处理后的字符
     */
    public static String humpToLine(@Nullable String str) {
     ...
     * @return 处理后的字符
     */
    public static String humpToLine(@Nullable String str, @Nullable String symbol) {
        if(ObjectUtils.isEmpty(str)){
            return FinalVariable.EMPTY_STRING;
        }
        symbol = symbol == null ? FinalVariable.EMPTY_STRING : symbol;
     ...
     * @return 处理后的字符
     */
    public static String ltrim(@Nullable String str, @Nullable String character) {
        if(ObjectUtils.isEmpty(str)){
            return FinalVariable.EMPTY_STRING;
        }
        if(character == null){
     ...
     * @return 处理后的字符
     */
    public static String rtrim(@Nullable String str, @Nullable String character) {
        if(ObjectUtils.isEmpty(str)){
            return FinalVariable.EMPTY_STRING;
        }
        if(character == null){
     ...
     * @return 是否
     */
    public static boolean isJavaKeyword(@Nullable String input) {
     ...
     * @return 输出
     */
    public static String md5(@Nullable String input) {
        input = input == null ? FinalVariable.EMPTY_STRING : input;
